...
class MyOrderScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    context.dataProvider.getAllOrderByUser(context.userProvider.getLoginUsr()); //lấy từ exten
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "Đơn hàng của tôi",
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return OrderTile(
                ...
                items: '${(order.items.safeElementAt(0)?.productName ?? '')} & ${order.items!.length - 1} Đơn'  ,
